...
static ligo::python_module mod("libtest_abstract_objects",
    "module for testing abstract types");

PyMODINIT_FUNC PyInit_libtest_abstract_objects() {
  ligo::overload_set object_arg("object_arg");
  object_arg.add_overload(
      [](ligo::python_object& a) { Py_RETURN_TRUE; }, {"a"});
  ...
  callable_arg.add_overload(
      [](ligo::python_callable& a) { Py_RETURN_TRUE; }, {"a"});
  ...
  number_arg.add_overload(
      [](ligo::python_number& a) { Py_RETURN_TRUE; }, {"a"});
  ...
  index_arg.add_overload(
      [](ligo::python_index& a) { Py_RETURN_TRUE; }, {"a"});
  ...
  sequence_arg.add_overload(
      [](ligo::python_sequence& a) { Py_RETURN_TRUE; }, {"a"});
  ...
  mapping_arg.add_overload([](ligo::python_mapping& a) {
      Py_RETURN_TRUE;
    }, {"a"});
